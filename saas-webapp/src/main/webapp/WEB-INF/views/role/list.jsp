...
<layout:page>
	<div class="OA-wrapper span12">
		...
		<div class="btn-group pull-right">					
			<a href="${pageContext.request.contextPath}/role/create" class="btn btn-primary"><i class="icon-plus"></i> Add a Role</a>
		</div>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="table" id="saas_datatable">
				<thead>
					<tr class="OA-header-background">
						<th width="30%"><spring:message code='label_role_name' /></th>
						<th width="30%" class="hidden-phone"><spring:message code='label_role_description' /></th>
						<th width="20%" class="hidden-phone"><spring:message code='label_role_lastupdated_date' /></th>
...
//-->
		...
		function renderAction(id,status) {
			var actionHtml = 
			'<div class="btn-group pull-right">' + 
				'<a href="${pageContext.request.contextPath}/role/update/'+ id + '" class="btn btn-small"><i class="icon-edit"></i> <spring:message code="label_btn_role_edit"/></a>' + 
				'<a href="#" data-toggle="dropdown" class="btn dropdown-toggle btn-small"><span class="caret"></span></a>'+
				'<ul class="dropdown-menu">'+
					'<li><a href="${pageContext.request.contextPath}/role/delete/'+ id + '"><i class="icon-trash"></i><spring:message code="label_btn_role_delete"/></a></li>'+
				'</ul>'+
			'</div>'
			return actionHtml;
		}  
