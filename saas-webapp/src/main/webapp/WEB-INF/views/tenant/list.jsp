...
<layout:page>
	<div class="OA-wrapper span12">
		...
		<div class="btn-group pull-right">					
			<a href="${pageContext.request.contextPath}/tenant/create" class="btn btn-primary"><i class="icon-plus"></i> Add a Tenant</a>
		</div>
		...
		$(document).ready(function() {
			...
			oDataTable = $('#saas_datatable').dataTable( {  
						    ...
						    "fnServerParams" : function(aoData){
                            	aoData.push( { "name": "parentTenantId", "value": "${sessionScope.TENANT_ID.id}"} ); 
                       		 }
						});  
		} );
