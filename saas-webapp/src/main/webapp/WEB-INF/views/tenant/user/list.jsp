...
<layout:page>
	...
	<div class="OA-wrapper span9">

		<div class="btn-group pull-right">					
			<a href="${pageContext.request.contextPath}/tenant/user/create_${tenant.id}" class="btn btn-primary"><i class="icon-plus"></i> Add a user</a>
		</div>
		...
		$(document).ready(function() {
			...
			oDataTable = $('#saas_datatable').dataTable( {  
						    ...
						    "fnServerParams" : function(aoData){
                                	aoData.push( { "name": "tenantId", "value": "${tenant.id}"} ); 
                           		 }
						});  
		} );
		...
		function renderAction(id) {  
			...
			'<div class="btn-group pull-right">' + 
				...
				'<ul class="dropdown-menu">'+
					'<li><a href="${pageContext.request.contextPath}/tenant/user/update/${tenant.id}/'+ id + '"><i class="icon-edit"></i><spring:message code="label_btn_editUser"/></a></li>'+
					'<li class="divider"></li>'+
					'<li><a href="${pageContext.request.contextPath}/tenant/user/delete/${tenant.id}/'+ id + '"><i class="icon-trash"></i><spring:message code="label_btn_deleteUser"/></a></li>'+
				'</ul>'+
			'</div>'
			return actionHtml;
		}  
