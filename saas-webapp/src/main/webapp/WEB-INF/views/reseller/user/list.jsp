...
<layout:page>
	<div class="OA-wrapper span12">
		...
		<div class="btn-group pull-right">					
			<a href="${pageContext.request.contextPath}/reseller/user/create" class="btn btn-primary"><i class="icon-plus"></i> Add a user</a>
		</div>
		...
		function renderAction(id) {  
			...
			'<div class="btn-group pull-right">' + 
				...
				'<ul class="dropdown-menu">'+
					'<li><a href="${pageContext.request.contextPath}/reseller/user/update/'+ id + '"><i class="icon-edit"></i><spring:message code="label_btn_editUser"/></a></li>'+
					'<li class="divider"></li>'+
					'<li><a href="${pageContext.request.contextPath}/reseller/user/delete/'+ id + '"><i class="icon-trash"></i><spring:message code="label_btn_deleteUser"/></a></li>'+
				'</ul>'+
			'</div>'
			return actionHtml;
		}  
